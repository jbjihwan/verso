...
import { app, startApp, registerScreens, registerOverlays, setRunValidator } from './ui/app.js';
import { initTips } from './ui/tooltip.js';
import { validateRun } from './core/run.js';
import { debugFight, debugWin, debugRoom } from './ui/flow.js';
...
registerOverlays({ settings, confirm, deck, inspect, pick });
...
if (app.debug) {
  window.verso = { app, fight: debugFight, win: debugWin, room: debugRoom };
}
